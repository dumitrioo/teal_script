...
The engine is implemented as an execution tree interpreter and does not rely on third-party tools for lexical analysis, parsing, or code generation, giving it a very small memory footprint. Because source code is compiled into an execution tree rather than machine code, the library is hardware-agnostic and portable to any system with a C++20 compiler.
