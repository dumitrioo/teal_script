...
namespace teal {
    ...
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eperm, "EPERM");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enoent, "ENOENT");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_esrch, "ESRCH");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enxio, "ENXIO");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_e2big, "E2BIG");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enoexec, "ENOEXEC");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_echild, "ECHILD");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enotblk, "ENOTBLK");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_ebusy, "EBUSY");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eexist, "EEXIST");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_exdev, "EXDEV");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enodev, "ENODEV");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enotdir, "ENOTDIR");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eisdir, "EISDIR");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enfile, "ENFILE");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_emfile, "EMFILE");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enotty, "ENOTTY");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_etxtbsy, "ETXTBSY");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_efbig, "EFBIG");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enospc, "ENOSPC");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_espipe, "ESPIPE");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_erofs, "EROFS");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_emlink, "EMLINK");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_edom, "EDOM");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_erange, "ERANGE");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eagain, "EAGAIN");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eacces, "EACCES");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_ebadf, "EBADF");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_econnreset, "ECONNRESET");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eintr, "EINTR");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_edestaddrreq, "EDESTADDRREQ");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_efault, "EFAULT");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_einval, "EINVAL");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eisconn, "EISCONN");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_emsgsize, "EMSGSIZE");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enobufs, "ENOBUFS");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enomem, "ENOMEM");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enotconn, "ENOTCONN");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enotsock, "ENOTSOCK");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_enotsupp, "ENOTSUPP");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_epipe, "EPIPE");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_eio, "EIO");
    DEFINE_RUNTIME_ERROR_CLASS_MSG(errno_ewouldblock, "EWOULDBLOCK");

    void throw_errno(int e, std::string const &description = std::string{}) {
        switch(e) {
...
#ifdef UNICODE
            return teal::str_util::to_utf8(std::wstring{szFileName});
#else
            return szFileName;
#endif
#else
