...
namespace teal {
    ...
    public:
        ...
        void register_runtime(runtime_interface *rt) override {
            ...
            rt->add_function("array_buffer", TEALFUN(args) {
            ...
            rt->add_method("array_buffer", "size", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                return TEALTHIS(args, std::shared_ptr<array_buffer>)->size();
            });
            rt->add_method("array_buffer", "resize", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                TEALTHIS(args, std::shared_ptr<array_buffer>)->resize(args[1].cast_to_size_t());
                return true;
            });
            rt->add_method("array_buffer", "fill_zero", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                TEALTHIS(args, std::shared_ptr<array_buffer>)->fill_with(0);
                return true;
            });
            rt->add_method("array_buffer", "fill_with", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                TEALTHIS(args, std::shared_ptr<array_buffer>)->fill_with(args[1].cast_to_char());
                return true;
            });
            ...
            rt->add_method("array_buffer", "sub_buffer", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 3)
                if(args.size() == 1) {
                    return valbox{TEALTHIS(args, std::shared_ptr<array_buffer>)->sub_buffer(), "array_buffer"};
                } else if(args.size() == 2) {
                    return valbox{TEALTHIS(args, std::shared_ptr<array_buffer>)->sub_buffer(args[1].cast_to_size_t()), "array_buffer"};
                } else if(args.size() == 3) {
                    return valbox{TEALTHIS(args, std::shared_ptr<array_buffer>)->sub_buffer(args[1].cast_to_size_t(), args[2].cast_to_size_t()), "array_buffer"};
                }
                throw std::runtime_error{"invalid argument(s)"};
            });
            rt->add_method("array_buffer", "to_string", TEALFUN(args) {
                return TEALTHIS(args, std::shared_ptr<array_buffer>)->to_string();
            });
            ...
            rt->add_method("array_buffer", "get_bool_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<bool>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_char_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<char>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_wchar_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<wchar_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_i8_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<int8_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_u8_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<uint8_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_i16_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<int16_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_u16_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<uint16_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_i32_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<int32_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_u32_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<uint32_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_i64_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<int64_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_u64_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<uint64_t>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_f32_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<float>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_f64_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<double>(args[1].cast_to_size_t())};
                return res;
            });
            rt->add_method("array_buffer", "get_float_at", TEALFUN(args) {
                TEAL_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{TEALTHIS(args, std::shared_ptr<array_buffer>)->get_at<long double>(args[1].cast_to_size_t())};
                return res;
            });
