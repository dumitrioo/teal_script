...
namespace scfx {
    ...
    public:
        ...
        void register_runtime(runtime_interface *rt) override {
            ...
            rt->add_function("file", SCFXFUN(/*fname*/, args) {
                if(args.size() == 1) {
            ...
            rt->add_method("file", "open", SCFXFUN(/*fname*/, args) {
                if(args.size() == 2) {
            ...
            rt->add_method("file", "to_string", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_method("file", "ok", SCFXFUN(/*fname*/, args) {
                return SCFXTHIS(std::shared_ptr<scfx_file>)->is_open();
            });
            rt->add_method("file", "read", SCFXFUN(/*fname*/, args) {
                if(args.size() == 2) {
            ...
            rt->add_method("file", "tellw", SCFXFUN(/*fname*/, args) {
                if(args.size() == 1) {
            ...
            rt->add_method("file", "size", SCFXFUN(/*fname*/, args) {
                if(args.size() == 1) {
