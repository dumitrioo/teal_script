...
namespace scfx {
    ...
    public:
        ...
        void register_runtime(runtime_interface *rt) override {
            ...
            rt_ = rt;
            if(rt_ == nullptr) { return; }
            rt->add_function("abs", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("mod", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("remainder", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("fma", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("deg2rad", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return scfx::math::deg2rad(args[0].cast_num_to_num<long double>()); });
            rt->add_function("rad2deg", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return scfx::math::rad2deg(args[0].cast_num_to_num<long double>()); });

            rt->add_function("gaussian", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("cos", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::cos(args[0].cast_num_to_num<long double>()); });
            rt->add_function("sin", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::sin(args[0].cast_num_to_num<long double>()); });
            rt->add_function("tan", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::tan(args[0].cast_num_to_num<long double>()); });
            rt->add_function("acos", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::acos(args[0].cast_num_to_num<long double>()); });
            rt->add_function("asin", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::asin(args[0].cast_num_to_num<long double>()); });
            rt->add_function("atan", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::atan(args[0].cast_num_to_num<long double>()); });
            rt->add_function("atan2", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::atan2(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });

            rt->add_function("cosh", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::cosh(args[0].cast_num_to_num<long double>()); });
            rt->add_function("sinh", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::sinh(args[0].cast_num_to_num<long double>()); });
            rt->add_function("tanh", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::tanh(args[0].cast_num_to_num<long double>()); });
            rt->add_function("acosh", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::acosh(args[0].cast_num_to_num<long double>()); });
            rt->add_function("asinh", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::asinh(args[0].cast_num_to_num<long double>()); });
            rt->add_function("atanh", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::atanh(args[0].cast_num_to_num<long double>()); });

            rt->add_function("exp", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::exp(args[0].cast_num_to_num<long double>()); });
            rt->add_function("frexp", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("ldexp", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::ldexp(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });
            rt->add_function("log", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::log(args[0].cast_num_to_num<long double>()); });
            rt->add_function("log10", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::log10(args[0].cast_num_to_num<long double>()); });
            rt->add_function("modf", SCFXFUN(/*fname*/, args) {
                SCFX_CHCK_FUN_PARMS_NUM_EQ(2)
                long double i{};
            ...
            rt->add_function("exp2", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::exp2(args[0].cast_num_to_num<long double>()); });
            rt->add_function("expm1", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::expm1(args[0].cast_num_to_num<long double>()); });
            rt->add_function("ilogb", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::ilogb(args[0].cast_num_to_num<long double>()); });
            rt->add_function("log1p", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::log1p(args[0].cast_num_to_num<long double>()); });
            rt->add_function("log2", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::log2(args[0].cast_num_to_num<long double>()); });
            rt->add_function("logb", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::logb(args[0].cast_num_to_num<long double>()); });
            rt->add_function("scalbn", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::scalbn(args[0].cast_num_to_num<long double>(), args[1].cast_to_s64()); });
            rt->add_function("scalbln", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(3) return std::scalbln(args[0].cast_num_to_num<long double>(), args[1].cast_to_s64()); });

            rt->add_function("pow", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::pow(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });
            rt->add_function("square", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0] * args[0]; });
            rt->add_function("qube", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) auto a{args[0].cast_num_to_num<long double>()}; return a * a * a; });
            rt->add_function("sqrt", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::sqrt(args[0].cast_num_to_num<long double>()); });
            rt->add_function("cbrt", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::cbrt(args[0].cast_num_to_num<long double>()); });
            rt->add_function("hypot", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::hypot(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });

            rt->add_function("erf", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::erf(args[0].cast_num_to_num<long double>()); });
            rt->add_function("erfc", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::erfc(args[0].cast_num_to_num<long double>()); });
            rt->add_function("tgamma", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::tgamma(args[0].cast_num_to_num<long double>()); });
            rt->add_function("lgamma", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::lgamma(args[0].cast_num_to_num<long double>()); });

            rt->add_function("ceil", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::ceil(args[0].cast_num_to_num<long double>()); });
            rt->add_function("floor", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::floor(args[0].cast_num_to_num<long double>()); });
            rt->add_function("fmod", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::fmod(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });
            rt->add_function("trunc", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::trunc(args[0].cast_num_to_num<long double>()); });
            rt->add_function("round", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::round(args[0].cast_num_to_num<long double>()); });
            rt->add_function("lround", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::lround(args[0].cast_num_to_num<long double>()); });
            rt->add_function("llround", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::llround(args[0].cast_num_to_num<long double>()); });
            rt->add_function("rint", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::rint(args[0].cast_num_to_num<long double>()); });
            ...
            rt->add_function("remquo", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("copysign", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::copysign(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });
            rt->add_function("nan", SCFXFUN(/*fname*/, args) { if(args.empty()) return std::nan(""); else return std::nan(args[0].cast_to_string().c_str()); });
            rt->add_function("nextafter", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::nextafter(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });
            rt->add_function("nexttoward", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(2) return std::nexttoward(args[0].cast_num_to_num<long double>(), args[1].cast_num_to_num<long double>()); });

            rt->add_function("fpclassify", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return std::fpclassify(args[0].cast_num_to_num<long double>()); });
            rt->add_function("isfinite", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1)
            ...
            rt->add_function("isinf", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1)
                switch(args[0].val_or_pointed_type()) {
            ...
            rt->add_function("isnan", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1)
                switch(args[0].val_or_pointed_type()) {
            ...
            rt->add_function("isnormal", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1)
                switch(args[0].val_or_pointed_type()) {
            ...
            rt->add_function("signbit", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1)
                switch(args[0].val_or_pointed_type()) {
            ...
            rt->add_function("rotation_z", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("rotation_x", SCFXFUN(/*fname*/, args) {
                long double ang{0.0L};
                if(args.size() == 1 && (args[0].is_any_fp_number() || args[0].is_any_int_number())) {
                    ang = args[0].cast_to_long_double();
                }
            ...
            rt->add_function("rotation_y", SCFXFUN(/*fname*/, args) {
                long double ang{0.0L};
                if(args.size() == 1 && (args[0].is_any_fp_number() || args[0].is_any_int_number())) {
                    ang = args[0].cast_to_long_double();
                }
            ...
            rt->add_function("rotation", SCFXFUN(/*fname*/, args) {
                long double ang{0.0L};
                long double vx{0.0L};
                long double vy{0.0L};
                long double vz{0.0L};
            ...
            rt->add_function("identity", SCFXFUN(/*fname*/, /*args*/) { return valbox::mat4_t::identity(); });
            rt->add_function("mirror_x", SCFXFUN(/*fname*/, /*args*/) { return valbox::mat4_t::mirror_x(); });
            rt->add_function("mirror_y", SCFXFUN(/*fname*/, /*args*/) { return valbox::mat4_t::mirror_y(); });
            rt->add_function("mirror_z", SCFXFUN(/*fname*/, /*args*/) { return valbox::mat4_t::mirror_z(); });
            rt->add_function("length", SCFXFUN(/*fname*/, args) {
                SCFX_CHCK_FUN_PARMS_NUM_EQ(1)
                return args[0].as_vec4().length();
            });
            rt->add_function("at", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(3) return args[0].as_mat4().at(args[1].cast_to_u64(), args[2].cast_to_u64()); });
            rt->add_function("x", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().x(); });
            rt->add_function("y", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().y(); });
            rt->add_function("z", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().z(); });
            rt->add_function("w", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().w(); });

            rt->add_function("spheric_to_cartesian", SCFXFUN(/*fname*/, args) {
                if(args.size() == 1) {
            ...
            rt->add_function("cartesian_to_spheric", SCFXFUN(/*fname*/, args) {
                if(args.size() == 1) {
                    if(args[0].is_array_ref()) {
                        long double vx{};
                        long double vy{};
            ...
            rt->add_function("vec4_r", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().r(); });
            rt->add_function("vec4_theta", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().theta(); });
            rt->add_function("vec4_phi", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().phi(); });

            rt->add_function("angle3d", SCFXFUN(/*fname*/, args) {
                SCFX_CHCK_FUN_PARMS_NUM_EQ(2)
                return scfx::math::angle3d(args[0].as_vec4(), args[1].as_vec4());
            });

            rt->add_function("normalized", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_vec4().normalized(); });
            rt->add_function("inverted", SCFXFUN(/*fname*/, args) { SCFX_CHCK_FUN_PARMS_NUM_EQ(1) return args[0].as_mat4().inverted(); });
            rt->add_function("translation", SCFXFUN(/*fname*/, args) {
                long double dx{0.0L};
                long double dy{0.0L};
                long double dz{0.0L};
            ...
            rt->add_function("perspective", SCFXFUN(/*fname*/, args) {
            ...
            rt->add_function("look_at", SCFXFUN(/*fname*/, args) {
