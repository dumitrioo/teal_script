...
namespace scfx {
    ...
    public:
        ...
        void register_runtime(runtime_interface *rt) override {
            ...
            rt->add_method("timespec_wrapper", "weekday", SCFXFUN(args) { return SCFXTHIS(scfx::timespec_wrapper).weekday(); });
            rt->add_method("timespec_wrapper", "hour", SCFXFUN(args) { return SCFXTHIS(scfx::timespec_wrapper).hour(); });
            rt->add_method("timespec_wrapper", "min", SCFXFUN(args) { return SCFXTHIS(scfx::timespec_wrapper).min(); });
            rt->add_method("timespec_wrapper", "sec", SCFXFUN(args) { return SCFXTHIS(scfx::timespec_wrapper).sec_with_subsec(); });
            rt->add_method("timespec_wrapper", "seconds", SCFXFUN(args) { return SCFXTHIS(scfx::timespec_wrapper).seconds(); });
            rt->add_method("timespec_wrapper", "fseconds", SCFXFUN(args) { return SCFXTHIS(scfx::timespec_wrapper).fseconds(); });
